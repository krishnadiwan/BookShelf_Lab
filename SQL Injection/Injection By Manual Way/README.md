...
![Testing single quote](images/01-testing-single-quote.png)
...
![Testing double quote](images/02-testing-double-quote.png)
...
![Testing quote + double quote](images/03-testing-quote-doublequote.png)
...
![Testing closed double quotes](images/04-testing-closed-quotes.png)
...
![UNION SELECT - confirming column count](images/05-union-select-column-count.png)
...
![Extracting database name](images/06-union-select-database.png)
...
![Extracting MySQL version](images/07-union-select-version.png)
...
![Table enumeration - part 1](images/08-table-enum-1.png)
![Table enumeration - part 2](images/09-table-enum-2.png)
![Table enumeration - part 3](images/10-table-enum-3.png)
![Table enumeration - part 4](images/11-table-enum-4.png)
![Table enumeration - part 5](images/12-table-enum-5.png)
...
![Users table found](images/13-table-enum-users-found.png)
...
![Column enumeration - all columns](images/14-column-enum.png)
...
![Columns in users table](images/15-column-enum-users-table.png)
...
![Dumping credentials](images/16-dump-credentials.png)
...
![Query cheat sheet](images/17-query-cheatsheet.png)
